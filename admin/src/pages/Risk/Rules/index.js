...
export default class extends PureComponent {
	...
	// actions = [
	// 	{ name: '新增', icon: <Icon type="form" />, action: () => {} },
	// 	{ name: '修改', icon: <Icon type="edit" />, action: () => {} },
	// 	{ name: '删除', icon: <Icon type="delete" />, action: () => {} },
	// 	{ name: '导入', icon: <Icon type="cloud-upload" />, action: () => {} }
	// ];
